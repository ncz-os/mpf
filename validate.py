#!/usr/bin/env python3
"""
validate.py — validate an MPF envelope against schema/mpf-v0.1.json.
...
Usage:
  ...
  python validate.py --file export.json --schema schema/mpf-v0.1.json
...
DEFAULT_SCHEMA = REPO_ROOT / "schema" / "mpf-v0.1.json"
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        prog="mpf-validate",
        description=(
            "Validate an MPF envelope against schema/mpf-v0.1.json. The "
            "schema file is authoritative; this tool is a convenience runner."
        ),
    )
